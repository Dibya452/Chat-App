...
const Loginpage = () => {
  ...
  const [isDataSubmited,setIsDataSubmited] = useState(false);
    ...
    const onSubmitHandler = async (event)=>{
      ...
      // prepare payload and correct route
      if (currentState === 'Sign up') {
        await login('signup', { fullName: Fullname, email, password, bio });
      } else {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-cebter gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
    {/*--------left-----------*/}
    ...
    {currentState === "Sign up" && isDataSubmited &&(
      ...
      className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 ' placeholder='Provide a short bio...' required ></textarea>
    )}
    ...
    <div className='flrx flex-col gap-2' >
